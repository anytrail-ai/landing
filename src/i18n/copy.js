...
export const COPY = {
  en: {
    meta: {
      ...
      description:
        'Anytrail finds the buying signals in your market and works every opportunity with AI sales agents trained on your product catalog — answering inbound inquiries, diagnosing the application, preparing quotes, and following up for manufacturers and industrial distributors.',
      ogLocale: 'en_US',
    },
    navbar: {
      cta: 'Book a review',
    ...
    how: {
      label: 'HOW IT WORKS',
      title: 'Every opportunity follows the same path — from first signal to your sales team.',
      intro:
        'Anytrail runs your commercial process, step by step. Your team keeps control of pricing, technical recommendations, quotes, and the final sale.',
      steps: [
        { title: 'Signal or inquiry', body: 'An opportunity surfaces — a lead arrives from WhatsApp, an ad, or your website, or a buying signal points at an account worth working. Anytrail responds right away.' },
    ...
    different: {
      ...
      title: 'Not a chatbot. Not a database. Part of your sales operation.',
      intro:
        "Anytrail learns what you sell, asks your team's qualification questions, and works each opportunity through a real sales process. It knows when to keep the conversation going and when your salespeople should take over.",
      comparisons: [
  ...
  es: {
    meta: {
      ...
      description:
        'Anytrail detecta las señales de compra en tu mercado y trabaja cada oportunidad con agentes de IA entrenados en tu catálogo — responde consultas entrantes, diagnostica la aplicación, prepara cotizaciones y da seguimiento para fabricantes y distribuidores industriales.',
      ogLocale: 'es_ES',
    },
    navbar: {
    ...
    how: {
      label: 'CÓMO FUNCIONA',
      title: 'Cada oportunidad sigue el mismo camino — de la primera señal a tu equipo de ventas.',
      intro:
        'Anytrail lleva tu proceso comercial, paso a paso. Tu equipo mantiene el control de precios, recomendaciones técnicas, cotizaciones y la venta final.',
      steps: [
        { title: 'Señal o consulta', body: 'Aparece una oportunidad — llega un lead por WhatsApp, un anuncio o tu sitio web, o una señal de compra apunta a una cuenta que vale la pena trabajar. Anytrail responde de inmediato.' },
    ...
    different: {
      ...
      title: 'No es un chatbot. No es una base de datos. Es parte de tu operación de ventas.',
      intro:
        'Anytrail aprende lo que vendes, hace las preguntas de calificación de tu equipo y trabaja cada oportunidad dentro de un proceso de ventas real. Sabe cuándo seguir la conversación y cuándo deben entrar tus vendedores.',
      comparisons: [

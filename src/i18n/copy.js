...
export const COPY = {
  en: {
    ...
    how: {
      ...
      entries: [
        { title: 'Anytrail finds it', body: 'It surfaces accounts that match what you sell — net-new companies in your market and customers already in your base worth going back to — then opens the conversation on WhatsApp, email, or LinkedIn.' },
  ...
  es: {
    ...
    how: {
      ...
      entries: [
        { title: 'Anytrail la encuentra', body: 'Detecta cuentas que embonan con lo que vendes — empresas nuevas en tu mercado y clientes que ya están en tu cartera y vale la pena retomar — y abre la conversación por WhatsApp, correo o LinkedIn.' },
